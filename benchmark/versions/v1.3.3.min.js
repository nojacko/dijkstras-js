...
a+"["+d+"]";this.graph[e][g[0]]=g[1]}}};k.prototype.getPath=function(c,a){if("undefined"===typeof this.graph[c])throw"source "+c+" doesn't exist";if("undefined"===typeof this.graph[a])throw"target "+a+" doesn't exist";if(c===a)return[];this.queue=new l;this.queue.add(c,0);for(var b=this.previous[c]=null;b=this.queue.shift();){if(b===a){for(var e=[];null!=this.previous[b];)e.unshift(b),b=this.previous[b];return e}if(Infinity==this.queue.getDistance(b))break;var e=this.queue.getDistance(b),d;for(d in this.graph[b]){var g=
this.queue.getDistance(d),f=e+this.graph[b][d];f<g&&(this.queue.update(d,f),this.previous[d]=b)}}return[]};var l=function(){var c=function(){this.min=null;this.roots=[];this.nodes=[]};c.prototype.shift=function(){var a=this.min;if(null==a||1>this.roots.length)return this.min=null,a;this.remove(a);50<this.roots.length&&this.consolidate();for(var b=Infinity,e=this.roots.length,d=0;d<e;d++){var c=this.roots[d],f=this.getDistance(c);f<b&&(b=f,this.min=c)}return a};c.prototype.consolidate=function(){for(var a=
